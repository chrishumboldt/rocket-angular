...
import { DomAddParams, DomRatioParams } from '../../model/dom.model';
 ...
 * @param params.element - The element to add.
 * @param params.to - The DOM element to attach the element to. This can be a selector or an element
 */
function domAdd({ element, to }: DomAddParams): void {
 ...
 *
 * @param params - The deconstructed options object.
 * @param params.multiplier - How much to multiply the width value by.
 * @param params.selector - The selector of the DOM element.
 */
function domRatio({ multiplier = 1, selector }: DomRatioParams): void {
